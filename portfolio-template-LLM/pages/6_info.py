st.markdown(
    """
About Sowjanya:
Sowjanya is a seasoned professional with expertise in AI, Data Science technologies. Holding an Post grad degree in data Science from the University of Chandigarh (2024), Sowjanya is committed to delivering innovative solutions.
